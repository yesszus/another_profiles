...
if ($user['user_image'] == "")
{
return "<img src='".e_PLUGIN."another_profiles/images/noavatar.png' border='1' ".$avwidth." ".$avheight."  alt='' />"; 
}
else
{
...
<div id='tip".$user[user_id]."'>
	<img src='".e_PLUGIN."another_profiles/images/noavatar.png' border='1' ".$avwidth." ".$avheight."  alt='' />
</div>
<script type='text/javascript' language='javascript'>
	new Tip('tip".$user[user_id]."', '<br/><br/><img src=\"".e_PLUGIN."another_profiles/images/noavatar.png\" alt=\"\"/><br/>".$user[user_id].PROFILE_169a."<br/><br/><br/><br/>".PROFILE_386.$user['user_comments']."<br/>".PROFILE_389.$user['user_forums']."<br/>".PROFILE_392.$user['user_chats']."<br/><br/>', {
...
if ($online == 1) {
return "<img src='".e_PLUGIN."another_profiles/images/online.gif' border='1' alt='' />";
}
SC_END
...
$id = $user[user_id];
$sql_comments = new db;
$comments = $sql_comments->db_Count("another_profiles_com","(*)","where com_to = '$id' AND com_type = 'prof'  LIMIT 1");
if ($comments > 0 AND $pref['profile_memberlist_comment_info'] != "OFF" AND ($pref['profile_commentson'] == "ON" || $pref['profile_commentson'] == "") AND ($pref['profile_member_info'] == "Yes" || $pref['profile_member_info'] == "")) {
return "<a href='newuser.php?id=".$id."&page=comments'><img src='".e_PLUGIN."another_profiles/images/post1.png' border='0' alt='' width='16' title='".PROFILE_316." (".$comments.")' /></a>&nbsp;";
}
SC_END
...
$kepekszama = $intCount;
if ($kepekszama > 0 AND $pref['profile_memberlist_pic_info'] != "OFF" AND ($pref['profile_pics'] == "ON" || $pref['profile_pics'] == "") AND ($pref['profile_member_info'] == "Yes" || $pref['profile_member_info'] == "")) {
return "<a href='newuser.php?id=".$id."&page=images'><img src='".e_PLUGIN."another_profiles/images/pict.png' border='0' alt='' width='16' title='".PROFILE_317." (".$kepekszama.")' /></a>&nbsp;";
}
SC_END
...
$id = $user[user_id];
$sql_vid = new db;
$vid = $sql_vid->db_Count("another_profiles_vids","(*)","where vid_uid = '$id' LIMIT 1");
if ($vid > 0 AND $pref['profile_memberlist_vid_info'] != "OFF" AND ($pref['profile_videos'] == "ON" || $pref['profile_videos'] == "") AND ($pref['profile_member_info'] == "Yes" || $pref['profile_member_info'] == "")) {
return "<a href='newuser.php?id=".$id."&page=videos'><img src='".e_PLUGIN."another_profiles/images/vid.png' border='0' alt='' width='16' title='".PROFILE_113." (".$vid.")' /></a>&nbsp;";
}
SC_END
...
if ($forums > 0 AND $pref['profile_memberlist_forum_info'] != "OFF" AND ($pref['profile_member_info'] == "Yes" || $pref['profile_member_info'] == "")) {
	if (USER || check_class($pref['memberlist_access'])) {
		return "<a href='../../userposts.php?0.forums.".$id."'><img src='".e_PLUGIN."another_profiles/images/forum.png' border='0' alt='' width='16' title='".PROFILE_363." (".$forums.")' /></a>&nbsp;";
	} else {
		return "<a href='newuser.php?id=".$id."'><img src='".e_PLUGIN."another_profiles/images/forum.png' border='0' alt='' width='16' title='".PROFILE_363." (".$forums.")' /></a>&nbsp;";
	}
}
SC_END
...
if ($comments_1 > 0 AND $pref['profile_memberlist_comment_1_info'] != "OFF" AND ($pref['profile_member_info'] == "Yes" || $pref['profile_member_info'] == "")) {
	if (USER || check_class($pref['memberlist_access'])) {
		return "<a href='../../userposts.php?0.comments.".$id."'><img src='".e_PLUGIN."another_profiles/images/quote.png' border='0' alt='' width='16' title='".PROFILE_364." (".$comments_1.")' /></a>&nbsp;";
	} else {
		return "<a href='newuser.php?id=".$id."'><img src='".e_PLUGIN."another_profiles/images/quote.png' border='0' alt='' width='16' title='".PROFILE_364." (".$comments_1.")' /></a>&nbsp;";
	}
}
SC_END
...
$id = $user[user_id];
$sql_mp3 = new db;
$mp3 = $sql_mp3->db_Count("another_profiles","(*)","where user_id = '$id' AND user_mp3 !='' LIMIT 1");
if ($mp3 > 0 AND $pref['profile_memberlist_mp3_info'] != "OFF" AND $pref['profile_mp3enabled'] == "ON" AND ($pref['profile_member_info'] == "Yes" || $pref['profile_member_info'] == "")) {
return "<a href='newuser.php?id=".$id."'><img src='".e_PLUGIN."another_profiles/images/mp3.png' border='0' alt='' width='16' title=".PROFILE_318." /></a>";
}
SC_END

SC_BEGIN USER_WARN
global $sql, $user;
if($pref['profile_user_warn_support'] == "Yes") {
...
if (($pref['profile_friends'] == "ON" || $pref['profile_friends'] == "") && $pref['profile_memberlist_addtofriend'] == "Yes") {
global $sql, $user;
$id = $user[user_id];
	...
	if (USER && $id != USERID) {
		if ($pref['profile_memberlist_bcard'] == "line" || $pref['profile_memberlist_bcard'] == "" ) {
			$fr_img = e_PLUGIN."another_profiles/images/pm_small.png";
			if (in_array(USERID, $friendb)) $fr_img = e_PLUGIN."another_profiles/images/friend.png";
			if (in_array(USERID, $friendb1)) $fr_img = e_PLUGIN."another_profiles/images/fr_checked.png";
		} else {
			...
			$fr_img = e_PLUGIN."another_profiles/images/".$fr_img."";
		}
	$frimage = "<a href='newuser.php?id=".$id."&add' style=\"text-decoration: none;\" title='".PROFILE_16."'><img src='".$fr_img."' style='height:16px; padding-left: 2px; padding-right: 4px;' align='right' border='0' alt='' /></a>";
	if(in_array(USERID, $friendb)) {
		$frimage = "<a href='newuser.php?id=".$id."' style=\"text-decoration: none;\" title='".PROFILE_424."'><img src='".$fr_img."' style='height:16px; padding-left: 2px; padding-right: 4px;' align='right' border='0' alt='' /></a>";
	}
	if(in_array(USERID, $friendb1)) {
		$frimage = "<a href='newusersettings.php?page=friends' style=\"text-decoration: none;\" title='".PROFILE_425."'><img src='".$fr_img."' style='height:16px; padding-left: 2px; padding-right: 4px;' align='right' border='0' alt='' /></a>";
	}
	}
}
return $frimage;
...
SC_BEGIN USER_LIST
global $sql, $user;
$another_profiles_memberlist = new db;
$another_profiles_memberlist->db_Select("another_profiles_memberlist", "*");
$row = $another_profiles_memberlist->db_Fetch();
...
$profile_top = new db;
$profile_top->db_Select("another_profiles", "*", "user_id = ".$user['user_id']." LIMIT 1");
...
$friends_top = new db;
$friends_top->db_Select("another_profiles", "*", "user_id = ".$user['user_id']." LIMIT 1");
